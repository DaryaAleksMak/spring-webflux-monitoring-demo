...
public class ProductRestClientImpl implements
    ProductRestClient {
  ...
  public Product createProduct(String title, String details) {
    try {
      ...
      ProblemDetail problemDetail = errorException.getResponseBodyAs(ProblemDetail.class);
  ...
  public void deleteProduct(int productId) {
    try {
      ...
      throw new NoSuchElementException(errorException);
    }
